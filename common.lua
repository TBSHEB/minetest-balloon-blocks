...
balloonblocks.placeHeliumRed = placeColour('helium_red')
balloonblocks.placeHeliumYellow = placeColour('helium_yellow')
balloonblocks.placeHeliumGreen = placeColour('helium_green')
balloonblocks.placeHeliumBlue = placeColour('helium_blue')
balloonblocks.placeHeliumBlack = placeColour('helium_black')
balloonblocks.placeHeliumWhite = placeColour('helium_white')
balloonblocks.placeHeliumOrange = placeColour('helium_orange')
balloonblocks.placeHeliumPurple = placeColour('helium_purple')
balloonblocks.placeHeliumGrey = placeColour('helium_grey')
balloonblocks.placeHeliumPink = placeColour('helium_pink')
balloonblocks.placeHeliumBrown = placeColour('helium_brown')
